      ...
      <div className="min-h-screen bg-white flex flex-col justify-between font-sans">
        <main className="max-w-4xl mx-auto px-4 py-12 md:py-16 text-gray-900 flex-1">
          ...
          <div className="prose prose-lg max-w-none text-gray-800 leading-relaxed space-y-6 text-sm sm:text-base">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-black mt-8 mb-4">
            ...
            <ul className="list-disc list-inside text-gray-800 space-y-3 mb-6 ml-4">
              <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
              <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where &quot;control&quot; means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
              <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Creamson Publications, CREMSON PUBLICATIONS 2/42 1st Floor, Ansari Road, Darya Ganj, New Delhi-110002 011-45785945.</li>
              ...
              <li><strong>Website</strong> refers to Creamson Publications, accessible from <a href="https://cremsonpublications.com/" target="_blank" rel="noopener noreferrer" className="text-purple-600 underline">https://cremsonpublications.com/</a></li>
            ...
            <h4 className="text-base sm:text-lg font-bold text-black mt-4 mb-3">
              Personal Data
            </h4>
            ...
            <ul className="list-disc list-inside text-gray-800 space-y-4 mb-6 ml-4">
            ...
            <p className="font-semibold text-purple-700">
              By email: <a href="mailto:info@cremsonpublications.com" className="underline">info@cremsonpublications.com</a>
            </p>
          </div>
        </main>
      </div>
